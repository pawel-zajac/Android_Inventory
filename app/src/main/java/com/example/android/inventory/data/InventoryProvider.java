...
public class InventoryProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.android.iventory/items/3",
    ...
    /**
     * Insert am item into the database with the given content values. Return the new content URI
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        String contact = values.getAsString(ItemEntry.COLUMN_ITEM_CONTACT);
        if (contact == null) {
            throw new IllegalArgumentException("Item requires a contact");
        }
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ItemEntry#COLUMN_ITEM_CONTACT} key is present,
        // Check that the quantity is not null and positive
        if (values.containsKey(ItemEntry.COLUMN_ITEM_CONTACT)) {
            Long contact = values.getAsLong(ItemEntry.COLUMN_ITEM_CONTACT);
            if (contact == null) {
                throw new IllegalArgumentException("Item requires a contact");
            }
        }
